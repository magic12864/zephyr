...
class RtsUsb:
    ...
    def enable_download(self):
        if self.mode == "ROM":
            status = self.dev.ctrl_transfer(RTS_STANDARD_REQUEST | 0x80, RTS_STD_GET_STATUS, 0, 0, 1)
...
class RtsflashBinaryRunner(ZephyrBinaryRunner):
    ...
    def do_create(cls, cfg, args):
        ...
        ret = RtsflashBinaryRunner(cfg, args.dev_id, args.alt,
                                   args.img, exe=args.dfu_util)
